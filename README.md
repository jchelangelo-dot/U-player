...
## Current milestone
Milestone 4 foundation: MediaStore library scan, Media3 background playback, embedded album artwork with an ultramarine fallback, full Player controls, an 8-band parametric EQ, and a full-screen local lyrics editor/cache. Album art opens lyrics with Japanese original, Korean pronunciation, Korean translation display modes, and per-line manual timing correction. Provider interfaces keep future lyrics search, pronunciation, and translation services replaceable.
